...
def get_Redshift_connection():
    ...
    redshift_user = "jewoos15"  # 본인 ID 사용
    redshift_pass = "Jewoos15!1"  # 본인 Password 사용
    port = 5439
    dbname = "dev"
...
def transform(**context):
    text = context["task_instance"].xcom_pull(key="return_value", task_ids="extract") # extract 함수의 return 값을 가지고 오는 코드
    lines = text.split("\n")[1:]
    return lines
